...
- ურთიერთკავშირები ცხრილებს შორის - რელაციები, ინდექსაცია
- Numpy, Pandas, Matplotlib


# **თავი 14 - კომპიუტერი(სერვერი), Development გარემო, Linux-ი და კონკურენტული პროცესირება**
- კომპიუტერის არქიტექტურა, მეხსიერების ტიპები, BIOS, VM-ვირტუალური მანქანა, ოპერაციული სისტემები(ლინუქსი)
...
# **თავი 22 - პროექტის სრული ციკლი: აპლიკაციის დანერგვა და გაშვება**
- CI/CD Pipeline-ი
