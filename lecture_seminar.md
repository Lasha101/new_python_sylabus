...
- რა არის ბიბლიოთეკა
- ჩაშენებული მოდულები: math, datetime, random, os და sys (მეტი ყურადღება os-ზე და sys-ზე)
- import და საკუთარი ბიბლიოთეკის შექმნა
- შესავალი რელაციურ მონაცემთა ბაზებში - მონაცემების ცხრილური ტიპის სტრუქტურაში ორგანიზება - კოლონები და რიგები
- SQLite-ი როგორც მონაცემების პერმანენტული საცავი
- CRUD ოპერაციები(SQL vs Python - დეკლარატიული vs იმპერატიული პარადიგმა)
...
- შესავალი Flask-ში, ისტალაცია "Hello World" Flask-ით
- Jinja2 და Flask Forms-ი
- სერვერზე დარენდერებული ფრონტენდი vs ბრაუზერში გაშვებული ფრონტენდის კოდი
- CRUD ოპერაციები
