...
# **თავი 16 - FastAPI - მომზადება მასშტაბური პროექტებისთვის**
- ასინქრონული FastAPI
- Websocket-ი და Alembic-ი
- SOLID პრინციპები

# **თავი 17 - Django - შესავალი**
- შესავალი Django-ში
- Django Admin-ი - გაღრმავებული
- Models, Views, Templates

# **თავი 18 - Django Rest Framework - შესავალი**
- შესავალი DRF-ში
...
# **თავი 19 - DRF: ფუნქციონალები და მექანიზმები, და  PostgreSQL-ი**
