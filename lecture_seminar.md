...
- რა არის ბიბლიოთეკა
- ჩაშენებული მოდულები: time, datetime, random, requests, os და sys (მეტი ყურადღება request-ზე, os-ზე და sys-ზე)
...
ამოხსნილი დავალებების-რეგულარული გამოსახულებების თავის და 
მონაცემთა ბაზებთან მომუშავე ფუნქციების გატესტვა
...
- ფრონტი React-ზე(მზა კოდის გარჩევა და რეაქტის უპირატესობა DOM-თან შედარებით ორი სიტყვით)
