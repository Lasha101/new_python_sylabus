# **თავი 13 - Development გარემო და გარეშე ბიბლიოთეკები, კომპიუტერი, სერვერი**
- ლოკალური სამუშაო გარემოს გამართვა, პითონის და VSCode-ის ინსტალაცია, pip, ვირტუალური გარემო
- კომპიუტერის არქიტექტურა - CPU, RAM, SSD; BIOS/UEFI, OS, VM, Compiling vs Interpreting vs Jit
...
- ინდექსაცია - SQLIte, DuckDB

# **თავი 15 - კონკურენტული პროცესირება**
- ინტერნეტი, HTTP/HTTPS პროტოკოლები,  ბრაუზერი, HTML და CSS მიმოხილვა, ლინუქსი
- Git-ი, GitHub-ი
- I/O bound - ასინქრონულობა
