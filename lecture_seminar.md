...
- CPU და RAM ლიმიტირებული პროცესები - CPU bound გამოთვლები
...
- Git-ი, GitHub-ი
- RAM bound task-ები - ასინქრონულობა
- BIOS, ოპერაციული სისტემები(ლინუქსი)
- ინტერნეტი, ბრაუზერი, HTTP/HTTPS პროტოკოლები
- HTML, CSS და JS-ის მიმოხილვა
