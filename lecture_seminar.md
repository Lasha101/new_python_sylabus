...
- საბაზისო I/O - input() და print(), ცვლადები: გამოცხადება, მინიჭების ოპერაცია, დინამიურობა
...
- მინიჭება vs შედარება vs შედარება მონაცემთა ტიპების გათვალისწინებით
- სტრინგის ფორმატირება: concatenation, f-strings,format(), % formatting
- კომენტარები

**სემინარი**
- სტრინგის მეთოდების გარჩევა (W3schools)
...
- ფუნქციისთვის განსაზღრული პარამეტრი როგორც პლეისჰოლდერი ფუნქციისთვის ინფუთად გადაცემული მნიშვნელობისთვის
...
- ფუნქცია რომელიც არც ინფუთს შებულობს და არც აუთფუთს აბრუნებს(იძახებს სხვა ფუნქციებს)
