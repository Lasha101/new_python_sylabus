...
- კომპიუტერის არქიტექტურა, მეხსიერების ტიპები, BIOS, ოპერაციული სისტემები(ლინუქსი)
- CPU და RAM ლიმიტირებული პროცესები - ნაკადები და ასინქრონულობა 
- stack და heap მეხსიერება, numpy: array vs list, CPU cache vs RAM, SISD vs SIMD
